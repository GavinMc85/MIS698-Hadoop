...
CREATE TABLE train_z AS 
SELECT 
 srch_id, 
 prop_id, 
 zscore(prop_location_score2, ${mu_prop_loc}, ${std_prop_loc}) as prop_location_score2, 
 zscore(prop_review_score, ${mu_prop_review}, ${std_prop_review}) as prop_review_score, 
 zscore(promotional_flag, ${mu_promo_flag}, ${std_promo_flag}) as promotional_flag, 
 zscore(prop_starrating, ${mu_prop_starrating}, ${std_prop_starrating}) as prop_starrating FROM train_subset;
...
SELECT
 ...
 srch_id,
 prop_id,
 ((4*prop_location_score2)+(2*promotional_flag)+prop_review_score+(0.5*prop_starrating)) as rating
FROM train_z;
...
--hotel recommendation; selects top N hotels user has not seen
